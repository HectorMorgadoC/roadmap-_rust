  ...
  <div class="flex justify-center m-2">
    <div class="p-10 max-w-7xl w-full">
        ...
        <p class="text-[#EEE0D3] py-3 text-2xl font-medium leading-relaxed">
            ...
            de programación multiparadigmático que soporta programación funcional pura,
            por procedimientos, imperativa y orientada a objetos.
            Rust es un lenguaje de tipado estático, lo que significa que el tipo de
            una variable se determina durante la compilación, y tiene una extensa biblioteca
        ...
        <ul class="text-[#EEE0D3] py-3 text-2xl font-medium leading-relaxed">
          <li><strong>Seguridad:</strong> Rust se destaca por su sistema de seguridad de
            ...
            desbordamientos de búfer y fugas de memoria.</li>
          <li><strong>Rendimiento:</strong> Rust proporciona un control preciso sobre
            la asignación y liberación de memoria, lo que permite la creación de código
            altamente eficiente sin sacrificar la seguridad.</li>
          <li><strong>Concurrencia:</strong> Rust ofrece herramientas de concurrencia
            seguras que facilitan la escritura de programas paralelos y concurrentes sin
            preocuparse por problemas de carrera.</li>
          <li><strong>Legibilidad y mantenibilidad:</strong> Su sistema de tipos y
            concordancia de patrones promueve un código más legible y mantenible, lo que es
            fundamental en proyectos a largo plazo.</li>
        ...
        <ul class="text-[#EEE0D3] p-3 text-2xl font-medium leading-relaxed">
          <li>
            ...
            Las versiones de Rust en este canal han pasado por rigurosas pruebas y se
            consideran adecuadas para su uso en producción.
          </li>
          <li>
            <strong>2. Canal Beta:</strong> En este canal, se prueban características nuevas
            que se han considerado lo suficientemente maduras como para ser probadas en un
            entorno más amplio antes de ser lanzadas oficialmente en el canal estable.
            Aunque estas versiones son más estables que las de Nightly, aún pueden contener
            algunos errores o cambios que podrían afectar la compatibilidad con versiones
            anteriores.
          </li>
          <li>
            <strong>3. Canal Nightly:</strong> Este es el canal más experimental y menos
            estable. Aquí es donde se introducen las características más nuevas y emocionantes de Rust.
            Estas versiones se actualizan diariamente con el trabajo más reciente del equipo
            de desarrollo de Rust. Aunque las características en este canal pueden ser
        ...
        <p class="text-[#EEE0D3] py-3 text-2xl font-medium leading-relaxed">
          ...
          no utilizados", un atributo que distingue a Rust. La "seguridad de memoria" consiste
          en garantizar que el software no cause fugas de memoria ni punteros colgantes al acceder a la
          memoria del sistema. En Rust, la seguridad de la memoria se logra mediante un sistema
          llamado propiedad, con un conjunto de reglas que el compilador verifica en tiempo de
          compilación. Este sistema de propiedad elimina la necesidad de recolección de elementos
        ...
        <p  class="text-[#EEE0D3] py-3 text-2xl font-medium leading-relaxed">
          ...
          La abstracción de coste cero es otro concepto clave que Rust implementa. En general,
          las abstracciones en los lenguajes de programación permiten escribir código a
        ...
        <p class="text-[#EEE0D3] py-3 text-2xl font-medium leading-relaxed">
          ...
          de Rust lo optimizará para que se ejecute tan rápido como el código de bajo nivel
          escrito manualmente.
        </p>
    </div>
  </div>
